...
/**
 * Sign Up Page - Part of Task TK-007
 * * Integration: Supabase Auth (Register + Google)
 */
    ...
    <div className="max-w-md mx-auto py-12 px-6">
      <Card className="animate-fade-in relative overflow-hidden bg-white/5 backdrop-blur-xl border-white/10">
        ...
        <div className="px-6 pb-4 space-y-4">
          <Button 
            variant="outline" 
            className="w-full gap-3 justify-center py-6 text-base bg-white/5 border-white/10 text-white hover:bg-white/10" 
            disabled={isLoading}
          ...
          <div className="relative py-2">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-slate-900 px-2 text-slate-500">O regístrate con tu correo</span></div>
          </div>
        </div>
